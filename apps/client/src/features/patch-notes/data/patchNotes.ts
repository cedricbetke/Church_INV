...
export const patchNotesData: PatchNotesData = {
    ...
    entries: [
        ...
        },
        {
            ...
            summary: "Der Dokument-Upload im Inventarformular ist fuer Safari auf macOS robuster. Ausgewaehlte Dateien werden nach dem Oeffnen des Datei-Dialogs zuverlaessiger in die Dokumentliste uebernommen.",
            issueUrl: undefined,
            issueLabel: undefined,
            items: [
        ...
        },
        {
            version: "0.7.15",
            date: "2026-06-03",
            title: "Dokument-Uploads im Serverbetrieb stabilisiert",
            summary: "Dokument-Uploads funktionieren im Docker-Deployment jetzt auch fuer groessere erlaubte Dateien zuverlaessiger. Der Web-Proxy akzeptiert Upload-Requests passend zum App-Limit, und technische HTML-Fehlerseiten werden im Formular nicht mehr direkt angezeigt.",
            issueUrl: undefined,
            issueLabel: undefined,
            items: [
