    ...
    entries: [
        {
            version: "0.7.14",
            date: "2026-04-30",
            title: "Serverbetrieb und Datensicherung vorbereitet",
            summary: "ChurchINV ist fuer den dauerhaften Serverbetrieb vorbereitet. Bestehende Inventardaten, Bilder und Dokumente koennen auf den neuen Server uebernommen werden, und fuer die wichtigsten Daten gibt es jetzt einen vorbereiteten Backup-Ablauf.",
            issueUrl: undefined,
        ...
        },
        {
            ...
            summary: "Die Inventarliste ist bei groesseren Datenmengen jetzt deutlich besser bedienbar. Filter liegen nicht mehr inline ueber der Tabelle, sondern als eigenes Overlay vor, die Filterwerte kommen alphabetisch sortiert aus der API, und die Freitextsuche versteht mehr alltagstaugliche Schreibweisen. Zusaetzlich merkt sich die Web-App Theme, Update-Hinweise und die gewaehlte Tabellengroesse im Browser, und mehrere selten genutzte UI-Bausteine werden erst bei Bedarf nachgeladen.",
            issueUrl: undefined,
            issueLabel: undefined,
            items: [
        ...
        },
        {
            version: "0.7.12",
            date: "2026-04-09",
            title: "Testserver-Deploy per GitHub Actions eingerichtet",
            summary: "ChurchINV kann jetzt automatisiert auf einen externen Testserver deployed werden. Der Workflow prueft den Docker-Build vorab, synchronisiert das Repo per SSH auf den Server und startet die Container dort neu. Der Web-Client ist dabei fuer den externen Zugriff auf Port 51821 ausgelegt.",
            issueUrl: undefined,
            issueLabel: undefined,
            items: [
